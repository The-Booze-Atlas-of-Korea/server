...
public class PlanServiceImplTest {
    ...
    void createPlan_Success() {
        ...
        CreatePlanCommand command = new CreatePlanCommand(
                1L, "Test Plan", "Description", PlanTheme.FRIEND, 50000L, Arrays.asList(spot));
    ...
    void updatePlan_Success() {
        ...
        UpdatePlanCommand command = new UpdatePlanCommand(
                planId, userId, "New Title", "New Desc", PlanTheme.COMPANY, 50000L, null);
    ...
    void updatePlan_Unauthorized_Fail() {
        ...
        UpdatePlanCommand command = new UpdatePlanCommand(
                planId, unauthorizedUserId, "New Title", "New Desc", PlanTheme.COMPANY, 50000L, null);
